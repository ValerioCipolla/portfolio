export const projects = [
  {
    id: 1,
    title: "vrandom",
    sourceLink: "https://github.com/ValerioCipolla/vrandom",
    techStack: "JavaScript, Jest",
    language: "JavaScript",
    description:
      "The npm library that makes it easier to work with random numbers and random choices in JavaScript. I created, published and mantain this npm library. It's an open source project that anyone can contribute to. I originally started this project because I found it quite boring to work with the javascript Math object. If you want to get a random number you have to use Math.random() which gives you back a floating point number between 0 and 1 (1 not included). Crazy, right? So I created this library where I could create methods I - or anyone else - could use to make some tasks simpler. I wrote most of the methods and tests in the library and all of the documentation. The library is fully tested (100% coverage) and I have set up a CI workflow that runs on every pull-request and checks if the tests still pass, if they don't the merge won't be allowed.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    sourceLink: "https://github.com/ValerioCipolla/probability-calculator",
    techStack: "Python",
    language: "Python",
    description:
      "Scientific Computing with Python course on freeCodeCamp Project #5. Suppose there is a hat containing 5 blue balls, 4 red balls, and 2 green balls. What is the probability that a random draw of 4 balls will contain at least 1 red ball and 2 green balls? While it would be possible to calculate the probability using advanced mathematics, an easier way is to write a program to perform a large number of experiments to estimate an approximate probability. Working on this project, I learned how to create a class with a variable number of arguments in Python, and I worked with the random and copy libraries for the first time. To see my solution to this problem, click on the SOURCE CODE button.",
  },
  {
    id: 8,
    title: "Recipe Finder",
  ...
  },
  {
    ...
    sourceLink: "https://github.com/ValerioCipolla/polygon-area-calculator",
    techStack: "Python",
    language: "Python",
    description:
      "Scientific Computing with Python course on freeCodeCamp Project #4. This program allows the user to create Polygons with different sides length and then easily check the area, perimeter and diagonal of those polygons with easy-to-call methods. In addition, it is possible to print the shape in the console, by printing the object. On this project I learned how to create a sub-class of a class, and how the __init__ and __str__ method work in a Python Class. ",
  },
  {
    id: 10,
  ...
  },
  {
    id: 11,
    title: "Budget App",
    sourceLink: "https://github.com/ValerioCipolla/budget-app",
    techStack: "Python",
    language: "Python",
    description:
      "Scientific Computing with Python course on freeCodeCamp Project #3. This Python program is an interface that allows users to keep track of their spending by creating objects that work as 'bank accounts' that track money that comes in and out of the account. During this project I learned a lot about Object Oriented Programming and I used classes in a project for the first time. I also took advantage of some useful Python features like list comprehension and lambda functions. Additionally I built an external function called create_spend_chart, that when called with the 'bank accounts' that the user wants to inspect, will display in the console a histogram showing the weight of each category compared to the total spending.",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    sourceLink: "https://github.com/ValerioCipolla/time-calculator",
    techStack: "Python",
    language: "Python",
    description:
      "Scientific Computing with Python course on freeCodeCamp Project #2. This time calculator function takes 2 required and 1 optional parameter (the start time, time to add, and day of the week), the function should add the time to the start time and return how many days later it is. For example: add_time('11:43 PM', '24:20', 'TueSday') should return: 12:03 AM, Thursday (2 days later). During this project I had the chance to reinfornce some Python and programming fundamentals, I had to figure out how to work with string, extcracting certain parts and slicing, and I had to make heavy use of if statements to control the flow of my application.",
  },
  {
    id: 14,
  ...
  },
  {
    ...
    sourceLink: "https://github.com/ValerioCipolla/arithmetic-fortmatter",
    techStack: "Python",
    language: "Python",
    description:
      "Scientific Computing with Python course on freeCodeCamp Project #1. Students in primary school often arrange arithmetic problems vertically to make them easier to solve. I created a function that receives a list of strings that are arithmetic problems and returns the problems arranged vertically and side-by-side. The function takes a second argument. When the second argument is set to True, the answers will be displayed. Working on this project I had the chance to explore all of the useful built-in methods in Python for strings (rstrip(), lstrip()), I worked with white space characters and I made the most out of for loops and the easy Python syntax.",
  },
  {
    id: 16,
